...
rm -rf ~/Library/Application\ Support/BBEdit/Setup 2> /dev/null # Need to delete preexisting BBEdit Setup dir if it already exists, redirect stderr to suppress dir already exists log
