...
brew cask install android-studio bbedit calibre coconutbattery cryptomator dash disk-inventory-x drawio epubquicklook flux google-chrome karabiner-elements kindle kitty ksdiff libreoffice macdown nextcloud rectangle qlmarkdown qlmobi the-unarchiver torbrowser visual-studio-code
