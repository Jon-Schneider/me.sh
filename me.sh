...
brew cask install background-music bbedit calibre coconutbattery cryptomator dash disk-inventory-x drawio epubquicklook flux hammerspoon karabiner-elements kindle kitty ksdiff libreoffice macdown microsoft-edge onedrive qlmarkdown qlmobi the-unarchiver torbrowser visual-studio-code
